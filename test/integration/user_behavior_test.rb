...
class UserBehaviorTest < ActionDispatch::IntegrationTest
  ...
  test 'main-nav behaviors' do
    ...
    click_main_nav_item '#nav-open-courses', I18n.t('activerecord.models.enrollment'), '#enrollment-resource'
    # nav-repository
    ...
    click_main_nav_item '#nav-repository', I18n.t('activerecord.models.enrollment'), '#enrollment-resource'
    # signout
    click_link 'signout-btn'
  end
