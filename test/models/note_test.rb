...
class NoteTest < ActiveSupport::TestCase
  ...
  # validates :course_id, numericality: { equal_to: 0 }, allow_nil: false, if: "category == 'private'"
  test 'a private note with course_id that is not 0 is invalid' do
    assert_invalid build(:note, course_id: 1), :course_id
    assert_invalid build(:note, course_id: -1), :course_id
  end

  # validates :course_id, numericality: { greater_than: 0 }, allow_nil: false, if: "category != 'private'"
  ...
  # validates :original_ws_id, numericality: { greater_than_or_equal_to: 0 }, allow_nil: false, if: "category == 'work'"
  ...
  # validates :original_ws_id, numericality: { equal_to: 0 }, allow_nil: false, if: "category != 'work'"
